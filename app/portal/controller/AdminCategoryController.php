...
<tr class='data-item-tr'>
    <td>
        <input type='checkbox' class='js-check' data-yid='js-check-y' data-xid='js-check-x' name='ids[]' lay-filter='choose'
               value='\$id' data-name='\$name' \$checked>
    </td>
    <td class='data-td'>\$id</td>
    <td class='data-td'>\$spacer <a href='\$url' target='_blank'>\$name</a></td>
</tr>
tpl;
