...
class ArticleController extends HomeBaseController
{
    ...
    public function index()
    {
        ...
        $article    = $topicService->publishedArticle($articleId, $categoryId);
        ...
        $prevArticle = $topicService->publishedPrevArticle($articleId, $categoryId);
        $nextArticle = $topicService->publishedNextArticle($articleId, $categoryId);
        ...
        if (empty($categoryId)) {
            ...
            $category = $discussCategoryModel->where('id', $categoryId)->where('status', 1)->find();
        ...
        DiscussPostModel::where('id', $articleId)->inc('post_hits')->update();
    ...
    public function doLike()
    {
        ...
        if ($canLike) {
            DiscussPostModel::where('id', $articleId)->inc('post_like')->update();
