<?php /*a:7:{s:77:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/portal/article.html";i:1769524853;s:74:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/head.html";i:1765520921;s:78:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/function.html";i:1768462231;s:76:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/config.html";i:1759133767;s:73:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/nav.html";i:1768895638;s:76:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/footer.html";i:1769078028;s:77:"/www/wwwroot/www.hyperionrobot.com/public/themes/hyperion/public/scripts.html";i:1768896081;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<title><?php echo $article['post_title']; ?> <?php echo (isset($theme_vars['site_name']) && ($theme_vars['site_name'] !== '')?$theme_vars['site_name']:''); ?></title>
		<meta name="keywords" content="<?php echo (isset($site_info['site_seo_keywords']) && ($site_info['site_seo_keywords'] !== '')?$site_info['site_seo_keywords']:''); ?>"/>
		<meta name="description" content="<?php echo (isset($site_info['site_seo_description']) && ($site_info['site_seo_description'] !== '')?$site_info['site_seo_description']:''); ?>">
		<link rel="stylesheet" href="/static/css/index.css?v=3.11.1" />     <!---用于VDITOR--->
...
<!-- End Header -->
        ...
        <!-- Start Breadcrumb 
        ============================================= -->
        <!--<div class="breadcrumb-area bg-gray text-center shadow dark text-light bg-cover" style="background-image: url(/themes/hyperion/public/assets/img/banner/26.jpg);">-->
        <div class="breadcrumb-area bg-gray text-center shadow dark text-light bg-cover" style="background-image: url(https://src.hyperionrobot.com/hyper-web/banner_article.jpg);">    
            <div class="container">
                <div class="row">
        ...
        <!-- Start Blog
        ============================================= -->
        <div class="blog-area single full-blog right-sidebar full-blog default-padding pt-lg-5 pt-0">
            <div class="container">
                <div class="blog-items">
                    <div class="row">
                        <div class="blog-content col-lg-9 col-md-12" style="padding:0;">
                            <div class="item">
    
                                <div class="blog-item-box">
    
                                    <div class="content">
                                        <h3 style="font-size:22px;"><?php echo $article['post_title']; ?></h3>
                                        <div class="top-info">
                                            <ul>
                          <!--                      <li>-->
                          <!--                          <a href="javascript:;">-->
                          <!--                              <?php if(empty($vo['avatar'])): ?>-->
            									    	...
            									    	<!--<?php endif; ?>-->
                          <!--                              <?php echo $article['user']['user_nickname']; ?></a>-->
                          <!--                      </li>-->
                                                <li>
                                                    <i class="fas fa-calendar-alt"></i> <?php echo date('Y-m-d',$article['published_time']); ?>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <i class="fas fa-user"></i> <?php echo $article['post_hits']; ?>
                                                </li>
                                        ...
                                        <!--模板原版的内容页-->
										<!--<div id="article_content" style="text-align:left;">-->
										<!--	<?php echo $article['post_content']; ?>-->
										<!--</div>-->
										
										<!--用于VDITOR的内容页-->
										<div id="article_content">
                                            <div id="vditor" data-content="<?php echo htmlentities($article['post_content']); ?>"></div>
                                        </div>
                            ...
                            <div class="post-pagi-area">
                                <?php if(!empty($prev_article)): ?>
                                    <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$prev_article['id'])); ?>"><i class="fas fa-angle-double-left"></i>上一篇<h5><?php echo $prev_article['post_title']; ?></h5></a>
								<?php else: ?>
								    <a href="javacsript:;"><i class="fas fa-angle-double-left"></i>上一篇<h5>前面没有了！</h5></a>
								<?php endif; if(!empty($next_article)): ?>
									<a href="<?php echo cmf_url('portal/Article/index',array('id'=>$next_article['id'])); ?>">下一篇 <i class="fas fa-angle-double-right"></i><h5><?php echo $next_article['post_title']; ?></h5></a>
								<?php else: ?>
									<a href="javacsript:;">Next Post <i class="fas fa-angle-double-right"></i><h5>已是最新文章！</h5></a>
								<?php endif; ?>
                                
                            </div>
                            <!-- End Post Pagination -->
    
                            <!-- Start Post Tags   隐藏了分享模块-->
                            <div class="post-tags share d-none">    
                                <div class="tags">
                                    <?php echo $article['post_keywords']; ?>
                                    <!--<a href="#">Analysis</a>-->
                                    <!--<a href="#">Process</a>-->
                                </div>
                                <div class="social">
                            ...
                            <!-- End Post Tags 隐藏了分享模块  -->
    
                            <!-- Start Blog Comment 隐藏了评论模块-->
                            <div class="blog-comments d-none" style="border: 1px dashed #f2dede;padding: 5px;">
                                <div class="comments-area">
                                    <div class="comments-title">
                                        <p style="background-color:#f2dede;padding:5px 10px;">此区域这为评论板块，请安装评论插件！</p>
                                        <h4>
                                            5 comments
                                        </h4>
                                        <div class="comments-list">
                                            <div class="commen-item">
                                                <div class="avatar">
                                                    <img src="/themes/hyperion/public/assets/img/common/square.png" alt="Author">
                                                </div>
                                                <div class="content">
                                                    <div class="title">
                                                        <h5>Jonathom Doe</h5>
...
<?php
 ...
 ?>
                                ...
                                <!-- star   热门图片 隐藏-->
							    <?php
     if((isset($theme_widgets['hottest_img d-none']) && $theme_widgets['hottest_img d-none']['display'])){
        $widget=$theme_widgets['hottest_img d-none'];
 ?>
...
<?php
 ...
 ?>
                                ...
                                <!-- star 隐藏了分享图标 -->
                                <!-- <div class="sidebar-item social-sidebar d-none">
                                    <div class="title">
                                        <h4>follow us</h4>
                                    </div>
                                    <div class="sidebar-info">
...
<script type="text/javascript" charset="utf-8">
 ...
 ?>
		...
		<script src="/static/js/index.min.js?v=3.11.1"></script>
            ...
            <script>
                var markdownText = document.getElementById('vditor').getAttribute('data-content');
                
                // 解码HTML实体
                if (markdownText) {
                    var tempDiv = document.createElement('div');
                    tempDiv.innerHTML = markdownText;
                    markdownText = tempDiv.textContent || tempDiv.innerText || '';
                }
                ...
                vditor = new Vditor('vditor', {
                    ...
                    after: function () {
                        ...
                        setTimeout(function() {
                            ...
                            if (vditorElement) {
                                vditorElement.style.pointerEvents = 'auto';
                                // 只允许滚动，禁用其他交互
                                vditorElement.addEventListener('click', function(e) {
                                    e.preventDefault();
                                    e.stopPropagation();
                                });
                                vditorElement.addEventListener('keydown', function(e) {
                                    e.preventDefault();
                                    e.stopPropagation();
                                });
                                vditorElement.addEventListener('input', function(e) {
                                    e.preventDefault();
                                    e.stopPropagation();
                                });
                            }
