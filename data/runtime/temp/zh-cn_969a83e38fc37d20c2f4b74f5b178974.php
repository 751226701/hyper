...
<script src="/static/js/wind.js"></script>
		<script src="//api.map.baidu.com/api?v=1.4"></script>
		<?php 
...
<!-- End Header -->
		<!-- Start Breadcrumb 
        ============================================= -->
        <!--<div class="breadcrumb-area bg-gray text-center shadow dark text-light bg-cover" style="background-image: url(/themes/hyperion/public/assets/img/banner/17.jpg);">-->
        <div class="breadcrumb-area bg-gray text-center shadow dark text-light bg-cover" style="background-image: url(https://src.hyperionrobot.com/hyper-web/banner_contact.jpg);">
            <div class="container">
                <div class="row">
                ...
                <div class="contact-items">
                    <div class="row align-center">
                        ...
                        <div class="col-lg-8 right-item">
                            <!--<h5>需要帮助?</h5>-->
                            <h2>联系我们</h2>
                           <?php $guestbook=hook_one('guestbook'); if(empty($guestbook) && cmf_get_current_admin_id()): ?>
        ...
        <!-- Star Google Maps
        ============================================= -->
        <div class="maps-area" style="position: relative;z-index: -10;">
            <div id="mapCanvas" class="google-maps" style="height: 500px;">
                <?php 
					$company_location=empty($theme_vars['company_location'])?'120.67,31.12':$theme_vars['company_location'];
				...
				<script type="text/javascript">
					...
					var point = new BMap.Point("<?php echo $company_location_lng; ?>", "<?php echo $company_location_lat; ?>"); // 创建点坐标
					...
					var infoWindow = new BMap.InfoWindow("<?php echo (htmlspecialchars_decode($theme_vars['baidu_map_info_window_text']) ?: ''); ?>"); // 创建信息窗口对象
