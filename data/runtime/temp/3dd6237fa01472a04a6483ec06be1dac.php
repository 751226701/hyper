<?php /*a:2:{s:90:"/www/wwwroot/www.hyperionrobot.com/public/themes/admin_star/portal/admin_article/edit.html";i:1768566610;s:78:"/www/wwwroot/www.hyperionrobot.com/public/themes/admin_star/public/header.html";i:1760897858;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
            ...
            <div class="layui-card">
                <div class="layui-tab layui-tab-brief">
                    <ul class="layui-tab-title">
                        ...
                        <li class="layui-this"><a href="#" data-toggle="tab">编辑文章</a></li>
                    </ul>
                    <div class="layui-tab-content">
                        <form class="layui-form layui-form-pane js-ajax-form" action="<?php echo url('AdminArticle/editPost'); ?>"
                            method="post">
                                        ...
                                        <div class="layui-card-body">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input class="layui-input" type="text" required
                                                        value="<?php echo implode(' ',$post_categories); ?>" placeholder="请选择分类"
                                                        onclick="doSelectCategory();" id="js-categories-name-input"
                                                        readonly />
                                                    <input class="layui-input" type="hidden"
                                                        value="<?php echo $post_category_ids; ?>" name="post[categories]"
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input class="layui-input" type="text" name="post[more][post_title]"
                                                        id="sub_title" value="<?php echo (isset($post['more']['post_title']) && ($post['more']['post_title'] !== '')?$post['more']['post_title']:''); ?>" placeholder="请输入副标题" />
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input class="layui-input" type="text" name="post[post_keywords]"
                                                        value="<?php echo $post['post_keywords']; ?>"
                                                        placeholder="请输入关键字,多关键词之间用英文逗号隔开">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <div id="vditor"></div>
                                                    <textarea  name="post[post_content]" id="content" style="display:none;"><?php echo $post['post_content']; ?></textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="layui-form-item">
                                                        <div class="layui-inline" style="margin-right: 0;">
                                                            ...
                                                            <div class="layui-input-inline" style="width: auto;">
                                                                <ul id="photos" class="pic-list list-unstyled">
                                                                    <?php if(!(empty($post['more']['photos']) || (($post['more']['photos'] instanceof \think\Collection || $post['more']['photos'] instanceof \think\Paginator ) && $post['more']['photos']->isEmpty()))): if(is_array($post['more']['photos']) || $post['more']['photos'] instanceof \think\Collection || $post['more']['photos'] instanceof \think\Paginator): if( count($post['more']['photos'])==0 ) : echo "" ;else: foreach($post['more']['photos'] as $key=>$vo): $img_url=cmf_get_image_preview_url($vo['url']);
                                                                             ?>
                                                                            <li id="saved-image<?php echo $key; ?>" class="layui-form-item"
                                                                                style="margin-bottom: 5px;">
                                                                                <input id="photo-<?php echo $key; ?>" type="hidden"
                                                                                    name="photo_urls[]" value="<?php echo $vo['url']; ?>">
                                                                                <div class="layui-input-block"
                                                                                    style="margin-left: 0; display: flex; align-items: center;">
                                                                                    <input class="layui-input"
                                                                                        id="photo-<?php echo $key; ?>-name" type="text"
                                                                                        name="photo_names[]"
                                                                                        value="<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>"
                                                                                    ...
                                                                                    <div class="layui-btn-group">
                                                                                        <a class="layui-btn layui-btn-normal"
                                                                                            href="javascript:uploadOneImage('图片上传','#photo-<?php echo $key; ?>');"
                                                                                            title="上传">
                                                                                            <i
                                                                                                class="layui-icon layui-icon-upload"></i>
                                                                                        </a>
                                                                                        <a class="layui-btn layui-btn-danger"
                                                                                            href="javascript:(function(){$('#saved-image<?php echo $key; ?>').remove();})();"
                                                                                            title="删除">
                                                                                            <i
                                                                                                class="layui-icon layui-icon-delete"></i>
                                                                                        </a>
                                                                                        <a class="layui-btn layui-btn-warm"
                                                                                            href="javascript:(function(){$('#saved-image<?php echo $key; ?>').before($('#saved-image<?php echo $key; ?>').next());})();"
                                                                                            title="下移">
                                                                                            <i
                                                ...
                                                <div class="layui-col-md6">
                                                    <div class="layui-form-item">
                                                        <div class="layui-inline" style="margin-right: 0;">
                                                            ...
                                                            <div class="layui-input-inline" style="width: auto;">
                                                                <ul id="files" class="pic-list list-unstyled">
                                                                    <?php if(!(empty($post['more']['files']) || (($post['more']['files'] instanceof \think\Collection || $post['more']['files'] instanceof \think\Paginator ) && $post['more']['files']->isEmpty()))): if(is_array($post['more']['files']) || $post['more']['files'] instanceof \think\Collection || $post['more']['files'] instanceof \think\Paginator): if( count($post['more']['files'])==0 ) : echo "" ;else: foreach($post['more']['files'] as $key=>$vo): 
                                                                                $file_url=cmf_get_file_download_url($vo['url']);
                                                                             ?>
                                                                            <li id="saved-file<?php echo $key; ?>" class="layui-form-item"
                                                                                style="margin-bottom: 5px;">
                                                                                <input id="file-<?php echo $key; ?>" type="hidden"
                                                                                    name="file_urls[]" value="<?php echo $vo['url']; ?>">
                                                                                <div class="layui-input-block"
                                                                                    style="margin-left: 0; display: flex; align-items: center;">
                                                                                    <input class="layui-input"
                                                                                        id="file-<?php echo $key; ?>-name" type="text"
                                                                                        name="file_names[]" value="<?php echo $vo['name']; ?>"
                                                                                        style="width: 300px; margin-right: 8px;"
                                                                                        title="文件名称">
                                                                                    <a class="layui-btn layui-btn-primary"
                                                                                        id="file-<?php echo $key; ?>-preview"
                                                                                        href="<?php echo $file_url; ?>" target="_blank"
                                                                                        title="下载">
                                                                                        <i
                                                                                            class="layui-icon layui-icon-download"></i>
                                                                                    </a>
                                                                                    <div class="layui-btn-group">
                                                                                        <a class="layui-btn layui-btn-normal"
                                                                                            href="javascript:uploadOne('文件上传','#file-<?php echo $key; ?>','file');"
                                                                                            title="上传">
                                                                                            <i
                                                                                                class="layui-icon layui-icon-upload"></i>
                                                                                        </a>
                                                                                        <a class="layui-btn layui-btn-danger"
                                                                                            href="javascript:(function(){$('#saved-file<?php echo $key; ?>').remove();})();"
                                                                                            title="删除">
                                                                                            <i
                                                                                                class="layui-icon layui-icon-delete"></i>
                                                                                        </a>
                                                                                        <a class="layui-btn layui-btn-warm"
                                                                                            href="javascript:(function(){$('#saved-file<?php echo $key; ?>').before($('#saved-file<?php echo $key; ?>').next());})();"
                                                                                            title="下移">
                                                                                            <i
                                                                                                class="layui-icon layui-icon-down"></i>
                                                                                        </a>
                                        ...
                                        <div class="layui-card-body">
                                            ...
                                            <div class="layui-form-item" pane>
                                                <div class="layui-input-block" style="margin-left: 0;">
                                                    <input type="checkbox" name="post[post_status]" value="1" title="发布"
                                                        lay-skin="primary" lay-filter="post-status" <?php echo $status_yes; ?>>
                                                    <div id="post-status-error" style="color: red;display: none"></div>
                                                </div>
                                            </div>
                                            <div class="layui-form-item" pane>
                                                <div class="layui-input-block" style="margin-left: 0;">
                                                    <input type="checkbox" name="post[is_top]" value="1" title="置顶"
                                                        lay-skin="primary" lay-filter="is-top" <?php echo $is_top_yes; ?>>
                                                    <div id="is-top-error" style="color: red;display: none"></div>
                                                </div>
                                            </div>
                                            <div class="layui-form-item" pane>
                                                <div class="layui-input-block" style="margin-left: 0;">
                                                    <input type="checkbox" name="post[recommended]" value="1" title="推荐"
                                                        lay-skin="primary" lay-filter="recommended" <?php echo $recommended_yes; ?>>
                                                    <div id="recommended-error" style="color: red;display: none"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-fixed-footer">
                                <button type="submit" class="layui-btn js-ajax-submit"><i
                                        class="layui-icon layui-icon-success"></i><?php echo lang('SAVE'); ?></button>
                                <a class="layui-btn layui-btn-primary"
    ...
    <script>
        layui.use(['form', 'laydate'], function () {
            ...
            // 状态切换事件处理
            form.on('checkbox(post-status)', function (data) {
                var url = data.elem.checked ? publishYesUrl : publishNoUrl;
                $.ajax({
                    url: url,
                    type: "post",
                    dataType: "json",
            ...
            // 置顶切换事件处理
            form.on('checkbox(is-top)', function (data) {
                var url = data.elem.checked ? topYesUrl : topNoUrl;
                $.ajax({
                    url: url,
                    type: "post",
                    dataType: "json",
            ...
            form.on('checkbox(recommended)', function (data) {
                var url = data.elem.checked ? recommendYesUrl : recommendNoUrl;
                $.ajax({
                    url: url,
                    type: "post",
                    dataType: "json",
