...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <div class="single-item">
                                    <div class="item">
                                        <div class="thumb">
                                            <!--<img src="/themes/hyperion/public/assets/img/blog/33.jpg" alt="Thumb">-->
                                            
                                            <?php if(empty($vo['more']['post_link'])): if(empty($vo['more']['thumbnail'])): ?>
                                                    <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'])); ?>" style="min-height: 300px;display: block;background-position: center;background-size: 100% auto;background-image:url(/themes/hyperion/public/assets/img/common/picture_2.png)"></a>
        										<?php else: ?>
        										...
        										<?php endif; else: if(empty($vo['more']['thumbnail'])): ?>
                                                    <a target="_blank" href="<?php echo (isset($vo['more']['post_link']) && ($vo['more']['post_link'] !== '')?$vo['more']['post_link']:'#'); ?>" style="min-height: 300px;display: block;background-position: center;background-size: 100% auto;background-image:url(/themes/hyperion/public/assets/img/common/picture_2.png)"></a>
        										<?php else: ?>
