...
<input type="hidden" name="_captcha_id" value="">
        					...
        					<div class="form-group" style="text-align: center;">
                                <p>
                                    没有账号? <a href="<?php echo cmf_url('user/Register/index'); ?>">点击此处注册</a>
                                </p>
                            </div>
        				</form>
        			</div>
