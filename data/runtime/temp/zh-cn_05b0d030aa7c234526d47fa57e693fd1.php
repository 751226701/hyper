...
<!-- End Header -->
        ...
        <!-- Start Breadcrumb 
        ============================================= -->
        <div class="breadcrumb-area bg-gray text-center shadow dark text-light bg-cover" style="background-image: url(https://src.hyperionrobot.com/hyper-web/banner_case_video.jpg);">
            <div class="container">
                <div class="row">
        ...
        <div class="courses-area trend-layout  default-padding">
            ...
            <div class="center-tabs">
                <ul id="tabs" class="nav courses-ul">
                    <?php 
                        $categories = _wien_subCategories($category['id']);
                     if(is_array($categories) || $categories instanceof \think\Collection || $categories instanceof \think\Paginator): if( count($categories)==0 ) : echo "" ;else: foreach($categories as $key=>$vo): ?>
                    <li class="">
                        <a href="" data-target="#tab<?php echo $vo['id']; ?>" data-toggle="tab" class="nav-link"><?php echo $vo['name']; ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <!--<li class="nav-item">-->
                    <!--    <a href="" data-target="#tab2" data-toggle="tab" class="nav-link active">Curriculum</a>-->
                    <!--</li>-->
                    <!--<li class="nav-item">-->
                ...
                <div id="tabsContent" class="tab-content">
                    ...
                    <div id="tab<?php echo $vo['id']; ?>" class="tab-pane overview fade ">
                                    ...
                                    <!--<div class="meta">
                                        <ul>
                                            <li>
        										...
        										<?php endif; ?>
                                                <a href="#"> by <?php echo $vo['user']['user_nickname']; ?></a>
                                            </li>
                                        </ul>
                                    </div>-->
                                    <h4>
                                    ...
                                    <div class="bottom-info">
                                        ...
                                        <div class="enroll">
                                            <?php if(empty($vo['more']['video'])): ?>
    										    <a href="javascript:;" class="btn btn-theme effect btn-sm" style="background-color:#5f5f5f;border-color:#5f5f5f">立即播放</a>
    										<?php else: ?>
    											<a href="<?php echo cmf_get_image_url($vo['more']['video']); ?>" class="btn btn-theme effect btn-sm popup-youtube light item-center">立即播放</a>
    										<?php endif; ?>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 ?>
        ...
        <!-- End Courses Area -->
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <!--<div id="tab2" class="tab-pane curriculum fade"></div>-->
            </div>
...
<script type="text/javascript" charset="utf-8">
	$(function(){
		...
		<script type="text/javascript" charset="utf-8">
		    ...
		    $('#tabsContent div:first').addClass('active show');
		</script>
		<?php 
