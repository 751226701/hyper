                    ...
                    <div class="blog-content col-lg-8 col-md-12">
                        <div class="blog-item-box">
                            ...
                            <?php 
                             ...
                             ?>
                            <div id="categoryList">
                                <a href="<?php echo cmf_url('discuss/List/index',array('id'=>$categoryId)); ?>">全部</a>
                                ...
                                <a href="<?php echo cmf_url('discuss/List/index',array('id'=>$vo['id'])); ?>"><?php echo $vo['name']; ?></a>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                            <br />
                            <form method="post" action="<?php echo cmf_url('discuss/List/index',array('id'=>$category['id'])); ?>">
                            ...
                            <ul class="tab-link">
                                ...
                                <a href="<?php echo url('user/discuss/add'); ?>"><i class="fa fa-plus-circle"></i>&nbsp;发布话题</a>
                            </ul>
                            <div style="border: 1px solid #eaeeef;border-top: none;">
                                ...
                                <?php 
                                 ...
                                 $articles_data = \app\discuss\service\ApiService::articles([
    'field'   => '',
    'where'   => $where,
    'limit'   => '',
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;" style="margin-right:10px" >
                                             <?php if(empty($vo['user']['avatar'])): ?>
                                                <img src="/themes/hyperion/public/assets/img/headicon_one.png" class="media-object" alt="<?php echo $vo['post_title']; ?>" style="width:80px;height:80px"/>
                                                <?php else: ?>
                                                <img src="<?php echo cmf_get_image_url($vo['user']['avatar']); ?>" class="media-object" alt="<?php echo $vo['post_title']; ?>" style="width:100px;height:100px"/>
                                            <?php endif; ?>
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="<?php echo cmf_url('discuss/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>" style="color:#333;margin-bottom:10px"><?php echo $vo['post_title']; ?></a>
                                        </h4>
                                        ...
                                        <div>
                                            <div>
                                                <?php if(is_array($vo['categories']) || $vo['categories'] instanceof \think\Collection || $vo['categories'] instanceof \think\Paginator): if( count($vo['categories'])==0 ) : echo "" ;else: foreach($vo['categories'] as $key=>$voo): ?>
                                                    <a href="javascript:;" class="tag"><span class="label label-success"><?php echo $voo['name']; ?></span></a>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                <!--<a href="javascript:;"><span class="label label-warning"><?php echo $vo['user']['user_nickname']; ?></span></a>-->
                                                <a href="javascript:;"><i class="fa fa-eye"></i><span>&nbsp;<?php echo $vo['post_hits']; ?></span></a>
                                            </div>
                                            <span class="pull-right" style="color:#8d8d8d"><?php echo date('Y-m-d H:i',$vo['published_time']); ?></span>
                                        </div>
