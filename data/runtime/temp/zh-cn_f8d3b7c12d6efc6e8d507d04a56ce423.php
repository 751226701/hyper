...
<!-- End Header -->
		...
		<div class="container">
			<div class="article-box">
				<h3><?php echo (isset($page['post_title']) && ($page['post_title'] !== '')?$page['post_title']:''); ?></h3>
				<hr>
 ...
 ?>
        ...
        <script>
            $(document).ready(() => {
                ...
                const contentData = `<?php echo $page['post_content']; ?>`;
