                                   		...
                                   		<div class="col-md-3">
						                	<a href="javascript:;">
												<?php if(empty($avatar)): ?>
													...
													<?php else: ?>
													<img src="/upload/<?php echo $avatar; ?>" class="headicon" width="128"/>
												<?php endif; ?>
								          	</a>
							          	</div>
							          	<div class="col-md-9">
