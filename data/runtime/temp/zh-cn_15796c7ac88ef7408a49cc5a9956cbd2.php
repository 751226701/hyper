                                    ...
                                    <div class="media-left">
                                        <a href="javascript:;" style="margin-right:10px" >
                                             <?php if(empty($vo['user']['avatar'])): ?>
                                                <img src="/themes/robai/public/assets/img/headicon_one.png" class="media-object" alt="<?php echo $vo['post_title']; ?>" style="width:80px;height:80px"/>
                                                <?php else: ?>
