...
if(count($__SLIDE_ITEMS__) == 0): ?>
                    ...
                    <div class="carousel-item">
                        <div class="slider-thumb bg-cover" style="background-image: url(/themes/robai/public/assets/img/banner/8.jpg);"></div>
                        <div class="box-table shadow dark">
                            <div class="box-cell">
                                <div class="container">
                                    <div class="row">
                    ...
                    <div class="carousel-item">
                        <div class="slider-thumb bg-cover" style="background-image: url(/themes/robai/public/assets/img/banner/14.jpg);"></div>
                        <div class="box-table shadow dark">
                            <div class="box-cell">
                                <div class="container">
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 thumb">
                            <?php if(empty($widget['vars']['image_bg'])): ?>
								<img src="/themes/robai/public/assets/img/illustration/4.png" alt="Thumb">
							<?php else: ?>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="fun-fact">
                                        ...
                                        <a href="https://src.hyperionrobot.com/download.jpg" download="download.jpg">
                                            <!--<span class="timer" data-to="<?php echo $vo['content']; ?>" data-speed="3000"></span>-->
                                            <button type="" style="font-size: 24px; font-weight: bold; color:red; border: 3px solid red;"><?php echo $vo['title']; ?></button>
                                            <span class="medium"><?php echo $vo['content']; ?></span>
                                        </a>
                                    </div>
                                </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div class="event-box">
                                <div class="row">
                                    <?php if(empty($vo['image'])): ?>
                                        <div class="col-lg-4 item thumb" style="background-image: url(/themes/robai/public/assets/img/common/square.png);"></div>
                        			<?php else: ?>
                                    ...
                                    <div class="col-lg-5 col-md-7 item">
                                        <div class="content">
                                            ...
                                            <!--<ul>-->
                                            <!--    <li>-->
                                            <!--        <a href="advisor-single.html"><img src="/themes/robai/public/assets/img/advisor/6.jpg" alt="Thumb">Kevin & Amanda</a>-->
                                            <!--    </li>-->
 ...
 ?>
        ...
        <div class="testimonials-area carousel-shadow default-padding bottom-less">
            ...
            <div class="fixed-shape">
                <img src="/themes/robai/public/assets/img/shape/5.png" alt="Shape">
            </div>
            <!-- End Fixed Shape -->
            <div class="container">
                <div class="row">
                            ...
                            <div class="testimonials-carousel owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    ...
                                    <div class="provider">
                                        <div class="thumb">
                                            <?php if(empty($vo['image'])): ?>
            								    <img src="/themes/robai/public/assets/img/common/square.png">
            								<?php else: ?>
        ...
        <div class="fun-factor-area overflow-hidden bg-gradient text-light default-padding">
            <div class="container">
                <div class="fun-fact-items text-center">
                    <!-- Fixed BG -->
                    <div class="fixed-bg contain" style="background-color:#990033; background-image: url(/themes/robai/public/assets/img/map.svg);"></div>
                    <!-- Fixed BG -->
                    <div class="row">
                        <?php 
        					$features = $widget['vars']['features'];
