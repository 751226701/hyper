												...
												<div class="thumb">
													<a href="javascript:;">
														<?php if(empty($vo['more']['thumbnail'])): ?>
															<img src="/themes/hyperion/public/assets/img/common/picture_2.png"
																alt="Thumb">
															<?php else: ?>
