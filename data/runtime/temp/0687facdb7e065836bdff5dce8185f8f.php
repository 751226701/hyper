            ...
            <form method="post" class="js-ajax-form  margin-top-20" action="admin/theme/<?php echo $theme; ?>/file/setting">
                ...
                <div class="card">
                    <div class="list-group list-group-flush">
                        <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Nav/index'); ?>','<?php echo lang('ADMIN_NAV_INDEX'); ?>')"
                           class="list-group-item list-group-item-action"><?php echo lang('ADMIN_NAV_INDEX'); ?></a>
                        <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Slide/index'); ?>','<?php echo lang('ADMIN_SLIDE_INDEX'); ?>')"
                           class="list-group-item list-group-item-action"><?php echo lang('ADMIN_SLIDE_INDEX'); ?></a>
                        <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Link/index'); ?>','<?php echo lang('ADMIN_LINK_INDEX'); ?>')"
                           class="list-group-item list-group-item-action"><?php echo lang('ADMIN_LINK_INDEX'); ?></a>
                    </div>
                </div>

                <?php if(!(empty($file['more']['widgets_blocks']) || (($file['more']['widgets_blocks'] instanceof \think\Collection || $file['more']['widgets_blocks'] instanceof \think\Paginator ) && $file['more']['widgets_blocks']->isEmpty()))): if(is_array($file['more']['widgets_blocks']) || $file['more']['widgets_blocks'] instanceof \think\Collection || $file['more']['widgets_blocks'] instanceof \think\Paginator): if( count($file['more']['widgets_blocks'])==0 ) : echo "" ;else: $index=0; foreach($file['more']['widgets_blocks'] as $widgetsBlockName=>$widgetsBlock): ++$index; ?>
                        <div class="card margin-top-20">
                            <div class="d-flex card-header justify-content-between align-items-center">
                                <div>
                                    <?php if(empty($widgetsBlock['title']) || (($widgetsBlock['title'] instanceof \think\Collection || $widgetsBlock['title'] instanceof \think\Paginator ) && $widgetsBlock['title']->isEmpty())): ?>
                                        <?php echo lang('Untitled'); else: ?>
                                        <?php echo lang($widgetsBlock['title']); ?>
                                    <?php endif; ?>
                                </div>
                                <div>
                                    <a href="javascript:"
                                       ...
                                       data-block_name="<?php echo $widgetsBlockName; ?>"
                            ...
                            <ul class="list-group list-group-flush widgets-group"
                                data-file_id="<?php echo $file['id']; ?>"
                                data-block_name="<?php echo $widgetsBlockName; ?>"
                                data-admin_content_lang="<?php echo cmf_current_home_lang(); ?>">
                                <?php if(!(empty($widgetsBlock['widgets']) || (($widgetsBlock['widgets'] instanceof \think\Collection || $widgetsBlock['widgets'] instanceof \think\Paginator ) && $widgetsBlock['widgets']->isEmpty()))): if(is_array($widgetsBlock['widgets']) || $widgetsBlock['widgets'] instanceof \think\Collection || $widgetsBlock['widgets'] instanceof \think\Paginator): if( count($widgetsBlock['widgets'])==0 ) : echo "" ;else: foreach($widgetsBlock['widgets'] as $key=>$widget): ?>
                                        <li class="list-group-item list-group-item-action widgets-group-item"
                                            data-file_id="<?php echo $file['id']; ?>"
                                            data-id="<?php echo $key; ?>"
                                            data-title="<?php echo lang('SETTING'); ?>">
                                            <?php echo (isset($widget['title']) && ($widget['title'] !== '')?$widget['title']:''); ?>
                                            <a class="float-end btn btn-sm btn-danger js-ajax-delete"
                                               title="删除组件"
                                               data-toggle="tooltip"
                                               data-href="admin/theme/file/block/widget?file=<?php echo $file['id']; ?>&theme=<?php echo $theme; ?>&block_name=<?php echo $widgetsBlockName; ?>&widget_id=<?php echo $key; ?>"
                                            ...
                                            <?php if(empty($widget['display']) || (($widget['display'] instanceof \think\Collection || $widget['display'] instanceof \think\Paginator ) && $widget['display']->isEmpty())): ?>
                                                <div class="float-end btn btn-sm btn-light me-1"
                                                     title="隐藏"
                                                     data-toggle="tooltip">
                                                    <i class="fa fa-eye-slash "></i>
                                                </div>
                                            <?php endif; if(!(empty($widget['public_widget_id']) || (($widget['public_widget_id'] instanceof \think\Collection || $widget['public_widget_id'] instanceof \think\Paginator ) && $widget['public_widget_id']->isEmpty()))): ?>
                                    ...
                                    <div class="card margin-top-20">
                                        ...
                                        <div class="card-body">
                                            <?php echo _parse_vars($widget['vars'],'files['.$file['id'].'][widget_vars]['.$widgetName.']',1,$widgetName,$file['id']); if(!(empty($file['is_public']) || (($file['is_public'] instanceof \think\Collection || $file['is_public'] instanceof \think\Paginator ) && $file['is_public']->isEmpty()))): ?>
                                                <span class="pull-right badge text-bg-success"><?php echo lang('Public widget'); ?></span>
                ...
                <div class="form-group text-center" style="display: none;">
                    ...
                    <input type="hidden" name="id" value="<?php echo (isset($file['id']) && ($file['id'] !== '')?$file['id']:''); ?>">
